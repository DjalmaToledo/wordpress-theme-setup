...
function login_enqueue_scripts(){ ?>
    <div class="background-cover"></div>
        <style type="text/css" media="screen">
            ...
            #login p#nav a, #login p#backtoblog a{color: #dddc00 !important;}
            #login{
                z-index:9999;
                position:relative;
            ...
            .login h1 a {
                background: url('<?php echo get_bloginfo('template_directory') ?>/src/images/logo-recicalce.png') no-repeat center top !important;
